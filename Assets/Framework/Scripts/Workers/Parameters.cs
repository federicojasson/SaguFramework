...
namespace SaguFramework {
	...
	public sealed class Parameters : Worker {
		...
		public const float DepthCamera = 10000;
		public const float DepthCharacter = 4000;
		public const float DepthInventory = 5000;
		public const float DepthInventoryItem = 6000;
		public const float DepthInventoryTrigger = 7000;
		public const float DepthItem = 3000;
		public const float DepthMenu = 8000;
		public const float DepthRoom = 1000;
		public const float DepthRoomTrigger = 2000;
		public const float DepthSplashScreen = 9000;
		...
		private static Parameters instance; // The instance of this worker
		...
		public static string GetStateFilePath(string stateId) {
			...
			// Gets the state file path, according to the state's ID
